#!/usr/bin/env -S node
import type { Contract as End } from '../../snapshots/3cdf3248df5d650b23cdda917b03c36cdd538ca09b070da38f65293f4d8823a0/contract';
import endContract from '../../snapshots/3cdf3248df5d650b23cdda917b03c36cdd538ca09b070da38f65293f4d8823a0/contract.json' with { type: 'json' };
  ...
  override get operations() {
    return [
      ...
      this.addUnique({
        schema: 'public',
        table: 'gameGenre',
        constraint: 'gameGenre_gameId_genreId_key',
        columns: ['gameId', 'genreId'],
      }),
      this.addUnique({
        schema: 'public',
        table: 'gamePlatform',
        constraint: 'gamePlatform_gameId_platformId_key',
        columns: ['gameId', 'platformId'],
      }),
      this.addUnique({
        schema: 'public',
        table: 'genre',
        constraint: 'genre_slug_key',
        columns: ['slug'],
      }),
      this.addUnique({
        schema: 'public',
      ...
      this.createIndex({
        schema: 'public',
        table: 'gameGenre',
        index: 'gameGenre_gameId_idx_6cdb47f8',
        columns: ['gameId'],
      }),
      this.createIndex({
        schema: 'public',
        table: 'gameGenre',
        index: 'gameGenre_genreId_idx_8fce6a7b',
        columns: ['genreId'],
      }),
      this.createIndex({
        schema: 'public',
