...
export type StorageHash =
  StorageHashBase<'2e59844481b027439cd537f7c357502c718a719d73d97df6625ca013f7e6a50e'>;
export type ExecutionHash =
  ExecutionHashBase<'06a921ae289537ea779233c156b4c1b4a21c5842651a665c9d2efaa07785a6da'>;
...
export namespace Models {
  ...
  export type public_Game = {
    ...
    releaseDate: CodecTypes['pg/timestamptz-string@1']['output'] | null;
    developer: CodecTypes['pg/text@1']['output'] | null;
    publisher: CodecTypes['pg/text@1']['output'] | null;
    banner: CodecTypes['pg/text@1']['output'] | null;
    createdAt: CodecTypes['pg/timestamptz-string@1']['output'];
    updatedAt: CodecTypes['pg/timestamptz-string@1']['output'];
    genres: public_Genre[];
    platforms: public_Platform[];
    reviews: public_Review[];
    readonly [RelationKeys]?: 'genres' | 'platforms' | 'reviews';
  };
  export type public_Platform = {
    id: CodecTypes['pg/text@1']['output'];
    ...
    updatedAt: CodecTypes['pg/timestamptz-string@1']['output'];
    games: public_Game[];
    readonly [RelationKeys]?: 'games';
  };
  export type public_GamePlatform = {
    gameId: CodecTypes['pg/text@1']['output'];
    platformId: CodecTypes['pg/text@1']['output'];
    game: public_Game;
    platform: public_Platform;
    readonly [RelationKeys]?: 'game' | 'platform';
  };
  ...
  export type public_GameGenre = {
    gameId: CodecTypes['pg/text@1']['output'];
    genreId: CodecTypes['pg/text@1']['output'];
    game: public_Game;
    genre: public_Genre;
    readonly [RelationKeys]?: 'game' | 'genre';
  };
  export type public_Reviewer = {
    id: CodecTypes['pg/text@1']['output'];
    name: CodecTypes['pg/text@1']['output'];
    slug: CodecTypes['pg/text@1']['output'];
  ...
  export type public_Review = {
    ...
    gameId: CodecTypes['pg/text@1']['output'];
    reviewerId: CodecTypes['pg/text@1']['output'];
    createdAt: CodecTypes['pg/timestamptz-string@1']['output'];
    updatedAt: CodecTypes['pg/timestamptz-string@1']['output'];
    game: public_Game;
    reviewer: public_Reviewer;
    readonly [RelationKeys]?: 'game' | 'reviewer';
  };
}
...
export declare const models: {
  public: {
    ...
    Platform: Models.public_Platform;
    GamePlatform: Models.public_GamePlatform;
    Genre: Models.public_Genre;
    GameGenre: Models.public_GameGenre;
    Reviewer: Models.public_Reviewer;
        ...
        readonly entries: {
          readonly table: {
            ...
            readonly gameGenre: {
              ...
              primaryKey: { readonly columns: readonly ['gameId', 'genreId'] };
              uniques: readonly [];
              indexes: readonly [
                {
            ...
            readonly gamePlatform: {
              ...
              primaryKey: { readonly columns: readonly ['gameId', 'platformId'] };
              uniques: readonly [];
              indexes: readonly [
                {
            ...
            readonly relations: {
              readonly genres: {
                ...
                readonly through: {
                  ...
                  readonly parentColumns: readonly ['gameId'];
                  readonly childColumns: readonly ['genreId'];
              ...
              readonly platforms: {
                ...
                readonly through: {
                  ...
                  readonly namespaceId: 'public';
                  readonly parentColumns: readonly ['gameId'];
                  readonly childColumns: readonly ['platformId'];
                  readonly targetColumns: readonly ['id'];
                };
              };
              readonly reviews: {
            ...
            readonly relations: {
              readonly games: {
                ...
                readonly through: {
                  readonly table: 'gameGenre';
                  readonly namespaceId: 'public';
                  readonly parentColumns: readonly ['genreId'];
                  readonly childColumns: readonly ['gameId'];
                  readonly targetColumns: readonly ['id'];
                };
              };
            };
            ...
            readonly relations: {
              readonly games: {
                ...
                readonly through: {
                  readonly table: 'gamePlatform';
                  readonly namespaceId: 'public';
                  readonly parentColumns: readonly ['platformId'];
                  readonly childColumns: readonly ['gameId'];
                  readonly targetColumns: readonly ['id'];
                };
              };
