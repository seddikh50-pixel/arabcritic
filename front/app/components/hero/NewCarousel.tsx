...
//           <h1 className="text-2xl dark:text-gray-200 text-gray-600  font-bold whitespace-nowrap">الإصدارات الجديدة</h1>
...
//         <div className="absolute left-0 top-0 z-20 h-full w-10 bg-gradient-to-r from-white to-transparent dark:from-gray-950 dark:to-transparent" />      </Swiper>
    ...
    <div className="relative w-full mt-20">
      ...
      <div className="mb-2 flex justify-between gap-2 items-center mb-5">
        ...
        <div className="flex items-center gap-5">
          ...
          <h1 className="underline text-gray-500 whitespace-nowrap">
            عرض الكل
          </h1>
        </div>
